...
function Products() {
  const whatsappMessage = encodeURIComponent("Hi! I'm interested in ordering your graham balls.");
            ...
            <article key={product.id} className={styles.card}>
              ...
              <div className={styles.content}>
                ...
                <div className={styles.footer}>
                  <div className={styles.priceContainer}>
                    {product.price > 0 ? (
                      ...
                      <>
                        ...
                        <span className={styles.unit}>Contact for pricing</span>
                      </>
                    )}
                  </div>
                  ...
                  {product.price > 0 ? (
                    <a
                      href={`${companyInfo.social.whatsapp}?text=${whatsappMessage}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`${styles.orderButton} ${styles.whatsappButton}`}
                    >
